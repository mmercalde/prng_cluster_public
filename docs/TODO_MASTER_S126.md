# MASTER TODO LIST — S126
**Compiled:** 2026-03-02 (S114) | **Updated:** 2026-03-07 (S126)
**Sources:** TODO_MASTER_S120.md + S121–S126 session history
**Status:** First clean real-data Steps 1–6 complete. 85 survivors, CatBoost winner. All 26 GPUs operational (S125b).
...
- [ ] **Commit manifest fix to both repos** — `agent_manifests/window_optimizer.json` patched on Zeus (S120) but NOT committed. `window_trials→trials`, `enable_pruning`, `n_parallel` added to `default_params`.
...
### GPU Throughput Investigation (Execute After 200-Trial Run)
...
*Generated S101 — 2026-02-20 | Updated S114 — 2026-03-02 | Updated S120 — 2026-03-07 | Updated S126 — 2026-03-07*
