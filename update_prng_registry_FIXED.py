#!/usr/bin/env python3
"""
FIXED Python-based updater for prng_registry.py
Corrects the java_lcg_pytorch_gpu initialization bug
"""
import sys
import os
...
print("=" * 70)
print("prng_registry.py PyTorch GPU Updater (FIXED - v2)")
print("=" * 70)
print()
...
# Part 2: Add FIXED PyTorch GPU functions after CPU references
pytorch_functions = '''
# ============================================================================
...
print("✅ Added FIXED PyTorch GPU functions")
