...
def train_lightgbm(X_train, y_train, X_val, y_val, params: dict) -> dict:
    """
...
def train_xgboost(X_train, y_train, X_val, y_val, params: dict) -> dict:
    """
...
def train_catboost(X_train, y_train, X_val, y_val, params: dict) -> dict:
    """
...
def train_neural_net(X_train, y_train, X_val, y_val, params: dict) -> dict:
    """
