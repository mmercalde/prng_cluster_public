#!/bin/bash
# patch_npz_v3.sh - Update convert_survivors_to_binary.py to v3.0
# Adds all 22 metadata fields to NPZ (Team Beta ruling Jan 23, 2026)
#
# USAGE:
...
echo "=============================================="
echo "Patching convert_survivors_to_binary.py → v3.0"
echo "=============================================="

# Backup
cp convert_survivors_to_binary.py convert_survivors_to_binary.py.v2.backup
echo "✓ Backed up to convert_survivors_to_binary.py.v2.backup"

# Create the updated file
cat > convert_survivors_to_binary.py << 'CONVERTER_EOF'
#!/usr/bin/env python3
"""
...
echo "✓ Updated convert_survivors_to_binary.py to v3.0"

# Verify
echo ""
echo "Verifying..."
python3 -c "import convert_survivors_to_binary; print(f'Version: {convert_survivors_to_binary.VERSION}')"
...
echo "=============================================="
echo ""
echo "Next: Regenerate NPZ with full metadata:"
echo "  python3 convert_survivors_to_binary.py bidirectional_survivors.json"
echo ""
